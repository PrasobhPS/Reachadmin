            ...
            <div class="breadcrumb-wrapper">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Chandlery</li>
                    </ol>
                </nav>
            </div>
            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    ...
                    <div class="outer-data  w-100">
                        ...
                        <form method="POST" id="chandleryForm" class="edit-page"
                            action="{{ route('update-chandlery', $chandlery->id) }}" enctype="multipart/form-data">
                            @csrf

                            <h1 class="fs-2x text-dark mb-3 common-head">Edit Chandlery</h1>
                                    ...
                                    <div class="card w-100 p-5">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="status-container">
                                                        <label class="switch">
                                                            <input type="checkbox" name="chandlery_status" {{ $chandlery->chandlery_status === 'A' ? 'checked' : '' }}>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                <input type="text" name="chandlery_name"
                                                    ...
                                                    placeholder="Enter Chandlery Name"
                                                    value="{{$chandlery->chandlery_name}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <textarea name="chandlery_description"
                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 text_editor"
                                                        placeholder="Discription">{{ $chandlery->chandlery_description}}</textarea>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="chandlery_discount"
                                                        ...
                                                        value="{{ $chandlery->chandlery_discount }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="chandlery_website"
                                                        ...
                                                        value="{{ $chandlery->chandlery_website }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                <input type="number" name="chandlery_order"
                                                    ...
                                                    value="{{ $chandlery->chandlery_order }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <textarea name="coupon_code"
                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                        placeholder="Coupon Code">{{ $couponCodesString }}</textarea>
                                        ...
                                        <div class="row common-head show_chandlery">
                                            ...
                                            <div class="col-md-6">
                                                <div class="status-container">
                                                    <label class="switch">
                                                        <input type="checkbox" name="show_coupon_code" {{ $chandlery->show_coupon_code == '1' ? 'checked' : '' }}>
                                                        <span class="slider"></span>
                                                    </label>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card w-100 p-5">
                                        <div class="row">
                                            ...
                                            @if(isset($chandlery->chandlery_image))
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container events-container">
                                                    <div class="event-image">
                                                        <img src="{{ asset('storage/' . $chandlery->chandlery_image) }}"
                                                            id="preview">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="card p-5">
                                                ...
                                                @if(isset($chandlery->chandlery_logo))
                                                    <div class="col-lg-6 fv-row fv-plugins-icon-container events-container">
                                                        <div class="event-image">
                                                            <img src="{{ asset('storage/' . $chandlery->chandlery_logo) }}"
                                                                id="preview_logo">
                                                        </div>
                            ...
                            <div class="card-footer d-flex justify-content-end px-0 py-3">
                                ...
                                <button type="submit" class="btn btn-primary" id="update_chandlery">Update</button>
                            </div>
