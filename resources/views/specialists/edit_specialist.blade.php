        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="outer-data  w-100">
                    <form method="POST" id="specialistForm" class="edit-page" action="{{ route('update-specialist', $specialist->id) }}"  enctype="multipart/form-data">
                        @csrf

                        <h1 class="fs-2x text-dark mb-3 common-head">Edit Specialist</h1>
                                    ...
                                    <div class="card w-100 p-5">
                                        ...
                                        <div class="profile-upload mb-3">
                                            <div class="d-flex align-items-center">
                                                @if(isset($specialist->specialist_profile_picture))
                                                <div class="mx-1">
                                                    <img src="{{ asset('storage/' . $specialist->specialist_profile_picture) }}" alt="Profile Picture" class="thumbnail photo" id="preview">
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="status-container">
                                                            <label class="switch">
                                                                <input type="checkbox" name="specialist_status" {{ $specialist->specialist_status === 'A' ? 'checked' : '' }}>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <textarea name="specialist_biography" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 text_editor" placeholder="Biography">{{ $specialist->specialist_biography}}</textarea>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <select name="specialist_title" aria-label="Select Title" data-control="select2" data-placeholder="Select Title..." class="form-select form-select-solid form-select-lg fw-semibold">
                                                        ...
                                                        <option value="{{ $roles->job_role }}"  data-select2-id="select2-data-12-8p9k" @if($specialist->specialist_title==$roles->job_role) selected @endif>{{ $roles->job_role }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="specialist_interest" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Interests" value="{{ $specialist->specialist_interest}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card w-100 p-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                <select name="member_id" class="form-select form-select-solid form-select-lg fw-semibold" onchange="getMemberDetails(this.value)">
                                                    ...
                                                    <option value="{{ $value->id }}" {{ $value->id == $specialist->member_id ? 'selected' : '' }}>{{ $value->members_fname.' '.$value->members_lname }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="specialist_fname" id="specialist_fname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name" value="{{$specialist->specialist_fname}}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="specialist_lname" id="specialist_lname" class="form-control form-control-lg form-control-solid" placeholder="Last name" value="{{$specialist->specialist_lname}}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="specialist_email" id="specialist_email" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Email" value="{{ $specialist->specialist_email}}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                                    <select name="specialist_phone_code" id="specialist_phone_code" aria-label="Select Phone Code" data-control="select2" data-placeholder="Select Phone Code..." class="form-select form-select-solid form-select-lg fw-semibold px-4">
                                                        ...
                                                        <option value="{{ $country->id }}" @if($country->id==$specialist->specialist_phone_code) selected="selected" @endif >+{{ $country->country_phonecode }} - {{ $country->country_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-lg-8 fv-row fv-plugins-icon-container px-1">
                                                    <input type="text" name="specialist_phone" id="specialist_phone" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Phone number" value="{{$specialist->specialist_phone}}">
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="specialist_dob" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="DOB" value="{{ date('d-m-Y',strtotime($specialist->specialist_dob)) }}" id="specialist_dob" readonly>
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="specialist_address" id="specialist_address" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Address" value="{{$specialist->specialist_address}}" >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <!--begin::Label-->
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <select name="specialist_country" id="specialist_country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a country..." class="form-select form-select-solid form-select-lg fw-semibold">
                                                        ...
                                                        @foreach($countries as $country)
                                                        <option value="{{ $country->country_name }}"  data-select2-id="select2-data-12-8p9k" @if($country->country_name==$specialist->specialist_country) selected="selected" @endif >{{ $country->country_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="specialist_region" id="specialist_region" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Region" value="{{ $specialist->specialist_region }}">
                                                </div>
                                            </div>
                                            <!-- <div class="col-md-6">
					                            <label class="col-lg-12 col-form-label fw-semibold fs-6">Specialist Video</label>
					                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
						                            <input type="file" id="specialist_video" name="specialist_video" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="" value="" >
						                        </div>
					                        </div> -->
                                        </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card w-100 p-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                <input type="text" name="specialist_employment" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Current Employment" value="{{ $specialist->specialist_employment }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                <textarea name="specialist_employment_history" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 text_editor2" placeholder="Employment History">{{ $specialist->specialist_employment_history}}</textarea>
                        ...
                        <div class="card-footer d-flex justify-content-end px-0 py-3">
	                        ...
	                        <button type="submit" class="btn btn-primary" id="update_specialist">Update</button>
	                    </div>
