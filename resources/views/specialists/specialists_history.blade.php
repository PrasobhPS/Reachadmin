            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="card w-100 p-5">
                    ...
                    <div class="d-flex align-items-center justify-content-between  mb-6 common-head">
                        <h1 class="fs-2x text-dark mb-0">{{ $specialist->members_fname.' '.$specialist->members_lname }} - Booking History</h1>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               <div class="user-block d-flex">
                                                    <div class="user-img">
                                                        @if($value->member->members_profile_picture!='')
                                                            <img src="{{ asset('storage/' . $value->member->members_profile_picture) }}" alt="Profile Picture">
                                                        @else
                                                            <img src="{{ asset('assets/images/noimage.jpg') }}" alt="Profile Picture">
                                                        @endif
                                                    </div>
                                                    <div class="user-label">
                                                        <label>{{ $value->member->members_fname.' '.$value->member->members_lname }}</label>
                                                        <span>{{ $value->member->members_employment }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
