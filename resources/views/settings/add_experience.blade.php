			...
			<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
				...
				<div class="event-outer w-100">
					<form method="POST" action="{{ route('save-experience') }}" enctype="multipart/form-data">
						...
						<h1 class="fs-2x text-dark mb-3 common-head">Add Experience</h1>
						<div class="row">
							<div class="col-md-6">
								<div class="card p-5 w-100">
									...
									<div class="row">
										...
										<div class="col-lg-12 fv-row fv-plugins-icon-container">
											<input type="text" name="experience_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="experience name" value="{{ old('experience_name') }}">
