            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="card w-100 p-5">
                    ...
                    <div class="d-flex align-items-center justify-content-between  mb-6 common-head">
                        <h1 class="fs-2x text-dark mb-0">Visa</h1>
                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <thead>
                                    <tr class="fw-bold fs-6 text-gray-800 border-0 bg-light">
                                        <th class="rounded-start">Visa</th>
                                    ...
                                    @if(!empty($visa))
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @elseif($visa->status=='I')
                                                    <span class="inactive" title="Inactive"><i class="fal fa-thumbs-down p-0"></i></span>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="d-flex">
                                                    <a class="m-1" href="{{ route('visa-edit', ['id' => $visa->id]) }}"><span class="edit m-0"><i class="fas fa-pencil"></i></span></a>
                                                  
                                                    @if (in_array($visa->id, $employee_visa))
                                                    <a href="#" disabled data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete disabled because this visa is in use" class="secondary m-1"  ><span class="cancel m-0" ><i class="fas fa-trash-alt"></i></span></a>
                                                    @else
                                                    <a class="m-1" href="#" onclick="confirmDelete('{{ route('delete-visa', ['id' => $visa->id]) }}')"><span class="delete m-0"><i class="fas fa-trash-alt"></i></span></a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
