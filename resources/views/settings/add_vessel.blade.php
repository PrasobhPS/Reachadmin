		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
				...
				<div class="event-outer w-100">
					<form method="POST" action="{{ route('save-vessel') }}" enctype="multipart/form-data">
						@csrf

						<h1 class="fs-2x text-dark mb-3 common-head">Add vessel Type</h1>
						<div class="row">
							<div class="col-md-6">
								<div class="card p-5 w-100">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="status-container">
													<label class="switch">
														<input type="checkbox" name="vessel_status">
									...
									<div class="row">
										...
										<div class="col-lg-12 fv-row fv-plugins-icon-container">
											<input type="text" name="vessel_type" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="vessel Type" value="{{ old('vessel_type') }}">
