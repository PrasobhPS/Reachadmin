                ...
                <div class="event-outer w-100">
                	<form method="POST" action="{{ route('update-event', $event->id) }}" enctype="multipart/form-data">
                        @csrf
	                     ...
	                     <h1 class="fs-2x text-dark mb-3 common-head">Edit Event</h1>
						<div class="row">
					      <div class="col-md-6">
							  ...
							  <div class="align-items-center d-flex justify-content-between">
						      	...
						      	<div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="status-container">
                                            <label class="switch">
                                                <input type="checkbox" id="event_status" name="event_status" {{ $event->event_status === 'A' ? 'checked' : '' }} >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="status-container">
                                            <label class="switch">
                                                <input type="checkbox" name="event_members_only" {{ $event->event_members_only === 'Y' ? 'checked' : '' }} >
                                                <span class="slider"></span>
                                            </label>
                                        </div>
                                    </div>
	                            ...
	                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
	                                <input type="text" name="event_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Event Name" value="{{ $event->event_name }}">
							...
							<div class="row">
	                            ...
	                            <!--begin::Col-->
	                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
	                                <textarea name="event_details" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Event Details" value="">{{ $event->event_details }}</textarea>
	                                <div class="fv-plugins-message-container invalid-feedback"></div>
	                            </div>
	                        </div>
							...
							<div class="row">
	                            ...
	                            <!--begin::Col-->
	                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
	                                <input type="text" name="event_start_date" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Start Date" id="startdate-datepicker" value="{{ date('d-m-Y', strtotime($event->event_start_date)) }}">
	                                <div class="fv-plugins-message-container invalid-feedback"></div>
	                            </div>
	                        </div>
							<div class="row">
	                            ...
	                            <!--begin::Col-->
	                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
		                            <input type="text" name="event_end_date" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="End Date" value="{{ date('d-m-Y', strtotime($event->event_end_date)) }}" id="enddate-datepicker">
		                        </div>
	                        </div>
                            <div class="row">
	                            <label class="col-lg-12 col-form-label required fw-semibold fs-6">Allowed Number of Members</label>
	                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
		                            <input type="number" name="event_allowed_members" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="" value="{{ $event->event_allowed_members }}" >
		                        </div>
	                        </div>
							</div>  
						  </div>
								...
								<div class="row">
									...
									<div class="col-lg-12 fv-row fv-plugins-icon-container events-container">
										<div class="event-image">
										   <img src="{{ asset('storage/' . $event->event_picture) }}" id="preview" >
										</div>
