        ...
        <div class="breadcrumb-wrapper">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Booking Payments</li>
                </ol>
            </nav>
        </div>
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="card w-100 p-5">
                    ...
                    <div class="d-flex align-items-center justify-content-between  mb-6 common-head">
                        <h1 class="fs-2x text-dark mb-0">Booking Payments List</h1>
                    </div>
                        ...
                        <form method="GET" action="{{ route('payments') }}">
                            <div class="row mb-10">
                                ...
                                <div class="col-md-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ route('payments') }}" class="btn btn-secondary mx-2">Reset</a>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="common-table-container table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <tbody class="border-bottom border-dashed">
                                    ...
                                    <tr>
                                        <td>{{ $index++ }}</td>
                                        <td>{{ $value->member?->members_fname . ' ' . $value->member?->members_lname ?? 'No Member Information' }}</td>
                                        <td> {{ $value->specialist ? $value->specialist->members_fname . ' ' . $value->specialist->members_lname : 'Member not found' }}</td>
                                        <td>
                                            <div class="fee-area">
                                                {{$currency. number_format($value->amount_paid, 2) }}
                                                <span></span>
                                            </div>
                                        </td>
